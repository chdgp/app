...
const PORT = process.env.PORT || 5000
    //APP_SECRET=IDENTIFICADOR DE LA APP se puede ver en el App Dashboard
...
/*
POST
URL:https://botsonrisasegura.herokuapp.com/webhook?hub.verify_token=botsonrisaseguratoken123Ej&hub.challenge=CHALLENGE_ACCEPTED&hub.mode=subscribe
 */
...
/*
GET
Verificar la conexion correcta con el webhook de face
 */
...
function verifyRequestSignature(req, res, buf) {
    console.log('function:----------------verifyRequestSignature-------------------');
...
function receivedAuthentication(event) {
    console.log('function:----------------receivedAuthentication-------------------');
    if (isStopped == true) {
        return;
    }
    var data = req.body;
...
function receivedMessage(event) {
    console.log('function:----------------receivedMessage-------------------');
...
function receivedDeliveryConfirmation(event) {
    console.log('function:----------------receivedDeliveryConfirmation-------------------');
    if (isStopped == true) {
        return;
    }
    var senderID = event.sender.id;
...
function receivedPostback(event) {
    console.log('function:----------------receivedPostback-------------------');
    if (isStopped == true) {
        return;
    }
...
function handleReceivedPostback(event) {
    console.log('function:----------------handleReceivedPostback-------------------');
    var senderID = event.sender.id;
    var recipientID = event.recipient.id;
...
function receivedMessageRead(event) {
    console.log('function:----------------receivedMessageRead-------------------');
    if (isStopped == true) {
        return;
    }
    var senderID = event.sender.id;
...
function sendImageMessage(recipientId, path) {
    console.log('function:----------------sendImageMessage-------------------');
    var messageData = {
        recipient: {
            id: recipientId
        },
...
function sendGifMessage(recipientId) {
    console.log('function:----------------sendGifMessage-------------------');
    var messageData = {
        recipient: {
            id: recipientId
        },
...
function sendAudioMessage(recipientId) {
    console.log('function:----------------sendAudioMessage-------------------');
    var messageData = {
        recipient: {
            id: recipientId
        },
...
function sendVideoMessage(recipientId) {
    console.log('function:----------------sendVideoMessage-------------------');
    var messageData = {
        recipient: {
            id: recipientId
        },
...
function sendFileMessage(recipientId) {
    console.log('function:----------------sendFileMessage-------------------');
    var messageData = {
        recipient: {
            id: recipientId
        },
...
function sendSingleJsonMessage(recipientId, filename) {
    console.log('function:----------------sendSingleJsonMessage-------------------');
    try {
...
function sendEnteredMessage(recipientId, messageText) {
    console.log('function:----------------sendEnteredMessage-------------------');
...
function sendCustomMessage(recipientId, messageText) {
    console.log('function:----------------sendCustomMessage-------------------');
...
function sendJsonMessage(recipientId, keyword) {
    console.log('function:----------------sendJsonMessage-------------------');
...
function sendLocale(recipientId) {
    console.log('function:----------------sendLocale-------------------');
...
function sendRandomImage(recipientId) {
    console.log('function:----------------sendRandomImage-------------------');
...
function sendButtonMessage(recipientId) {
    console.log('function:----------------sendButtonMessage-------------------');
    var messageData = {
        recipient: {
            id: recipientId
        },
...
function sendGenericMessage(recipientId) {
    console.log('function:----------------sendGenericMessage-------------------');
    var messageData = {
        recipient: {
            id: recipientId
        },
...
function sendReceiptMessage(recipientId) {
    console.log('function:----------------sendReceiptMessage-------------------');
...
function sendQuickReply(recipientId) {
    console.log('function:----------------sendQuickReply-------------------');
    var messageData = {
        recipient: {
            id: recipientId
        },
...
function sendReadReceipt(recipientId) {
    console.log('function:----------------sendReadReceipt-------------------');
...
//PAGINA DE INICIO heroku open
app.get('/', (req, res) => {
    res.status(200).send('bot de sonrisa segura')
});